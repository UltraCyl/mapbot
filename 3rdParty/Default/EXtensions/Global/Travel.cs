...
namespace Default.EXtensions.Global
{
    public static class Travel
    {
        ...
        private static readonly TgtPosition LioneyeWatchTgt
            = new TgtPosition(World.Act1.LioneyeWatch.Name, "beachtown_south_entrance_c2r2.tgt");

        private static readonly TgtPosition TidalIslandTgt
            = new TgtPosition(World.Act1.TidalIsland.Name, "act1_karui_coast_to_island_transition_v01_01_c9r3.tgt");

        private static readonly TgtPosition MudFlatsTgt
            = new TgtPosition(World.Act1.MudFlats.Name, "act1_area2_transition_v01_01_c4r2.tgt");

        private static readonly TgtPosition FetidPoolTgt
            = new TgtPosition(World.Act1.FetidPool.Name, "act1_beach_toswamp_fetid_v01_01_c5r3.tgt");

        private static readonly TgtPosition SubmergedPassageTgt
            = new TgtPosition(World.Act1.SubmergedPassage.Name, "Beach_to_watercave_v2_c3r4.tgt");

        private static readonly TgtPosition FloodedDepthsTgt
            = new TgtPosition(World.Act1.FloodedDepths.Name, "watery_depth_entrance_v01_01_c2r2.tgt");

        private static readonly TgtPosition LedgeTgt
            = new TgtPosition(World.Act1.Ledge.Name, "caveup_exit_v01_01_c2r2.tgt");

        private static readonly TgtPosition ClimbTgt
            = new TgtPosition(World.Act1.Climb.Name, "beach_passageway_v01_01_c3r4.tgt");

        private static readonly TgtPosition LowerPrisonTgt
            = new TgtPosition(World.Act1.LowerPrison.Name, "beach_prisonback_c6r4.tgt");

        private static readonly TgtPosition UpperPrisonTgt
            = new TgtPosition(World.Act1.UpperPrison.Name, "dungeon_prison_exit_up_v01_01_c1r1.tgt");

        private static readonly TgtPosition PrisonerGateTgt
            = new TgtPosition("Next prison level", "dungeon_prison_exit_up_v01_01_c1r1.tgt | dungeon_prison_boss_exit_v01_01_c1r2.tgt | dungeon_prison_door_up_v01_01_c1r1.tgt", true);

        private static readonly TgtPosition ShipGraveyardTgt
            = new TgtPosition(World.Act1.ShipGraveyard.Name, "shipgraveyard_passageway_v01_01_c4r3.tgt");

        private static readonly TgtPosition ShipGraveyardCaveTgt
            = new TgtPosition(World.Act1.ShipGraveyardCave.Name, "ship_entrance_v01_01_c2r6.tgt");

        private static readonly TgtPosition CavernOfWrathTgt
            = new TgtPosition(World.Act1.CavernOfWrath.Name, "beach_caveentranceskeleton_v01_01_c7r7.tgt | beach_caveentranceskeleton_v01_02_c6r4.tgt");

        private static readonly TgtPosition CavernOfAngerTgt
            = new TgtPosition(World.Act1.CavernOfAnger.Name, "caveup_exit_v01_01_c2r2.tgt");

        private static readonly TgtPosition SouthernForestTgt
            = new TgtPosition(World.Act2.SouthernForest.Name, "caveup_exit_v01_01_c2r2.tgt | merveil_exit_clean_v01_01_c1r2.tgt", true);

        private static readonly TgtPosition ForestEncampmentTgt
            = new TgtPosition(World.Act2.ForestEncampment.Name, "forestcamp_dock_v01_01_c3r3.tgt");

        private static readonly TgtPosition WesternForestTgt
            = new TgtPosition(World.Act2.WesternForest.Name, "roadtothickforest_entrance_v01_01_c6r2.tgt");

        private static readonly TgtPosition WeaverChambersTgt
            = new TgtPosition(World.Act2.WeaverChambers.Name, "spidergrove_entrance_v01_01_c4r2.tgt");

        private static readonly TgtPosition DenTgt
            = new TgtPosition(World.Act2.Den.Name, "forestcave_entrance_hole_v01_01_c1r1.tgt");

        private static readonly TgtPosition CrossroadsTgt
            = new TgtPosition(World.Act2.Crossroads.Name, "wall_gate_v01_01_c1r2.tgt");

        private static readonly TgtPosition ChamberOfSins1Tgt
            = new TgtPosition(World.Act2.ChamberOfSins1.Name, "temple_entrance_v01_01_c1r5.tgt");

        private static readonly TgtPosition ChamberOfSins2Tgt
            = new TgtPosition(World.Act2.ChamberOfSins2.Name, "templeruinforest_exit_down_v01_01_c2r4.tgt");

        private static readonly TgtPosition BrokenBridgeTgt
            = new TgtPosition(World.Act2.BrokenBridge.Name, "bridgeconnection_v01_01_c1r1.tgt");

        private static readonly TgtPosition Crypt1Tgt
            = new TgtPosition(World.Act2.Crypt1.Name, "church_dungeon_entrance_v01_01_c1r2.tgt");

        private static readonly TgtPosition Crypt2Tgt
            = new TgtPosition(World.Act2.Crypt2.Name, "dungeon_church_exit_down_v01_01_c1r1.tgt");

        private static readonly TgtPosition WetlandsTgt
            = new TgtPosition(World.Act2.Wetlands.Name, "bridgeconnection_v01_01_c1r3.tgt");

        private static readonly TgtPosition VaalRuinsTgt
            = new TgtPosition(World.Act2.VaalRuins.Name, "forest_caveentrance_inca_v01_01_c2r4.tgt");

        private static readonly TgtPosition NorthernForestTgt
            = new TgtPosition(World.Act2.NorthernForest.Name, "dungeon_inca_exit_v01_01_c1r2.tgt");

        private static readonly TgtPosition DreadThicketTgt
            = new TgtPosition(World.Act2.DreadThicket.Name, "grovewall_entrance_v01_01_c2r2.tgt");

        private static readonly TgtPosition CavernsTgt
            = new TgtPosition(World.Act2.Caverns.Name, "waterfall_cave_entrance_v01_01_c3r4.tgt");

        private static readonly TgtPosition AncientPyramidTgt
            = new TgtPosition(World.Act2.AncientPyramid.Name, "dungeon_stairs_up_v01_01_c1r2.tgt");

        private static readonly TgtPosition CityOfSarnTgt
            = new TgtPosition("Next pyramid level", "dungeon_stairs_up_v01_01_c1r2.tgt | dungeon_huangdoor_v01_01_c2r2.tgt", true);

        private static readonly TgtPosition SarnEncampmentTgt
            = new TgtPosition(World.Act3.SarnEncampment.Name, "act3_docks_to_town_lower_01_01_c4r2.tgt");

        private static readonly TgtPosition CrematoriumTgt
            = new TgtPosition(World.Act3.Crematorium.Name, "act3_prison_entrance_01_01_c2r3.tgt");

        private static readonly TgtPosition SewersTgt
            = new TgtPosition(World.Act3.Sewers.Name, "slum_sewer_entrance_v0?_0?.tgt");

        private static readonly TgtPosition MarketplaceTgt
            = new TgtPosition(World.Act3.Marketplace.Name, "sewerwall_exit_v01_01_c1r1.tgt");

        private static readonly TgtPosition CatacombsTgt
            = new TgtPosition(World.Act3.Catacombs.Name, "markettochurchdungeon_v01_01_c4r1.tgt");

        private static readonly TgtPosition BattlefrontTgt
            = new TgtPosition(World.Act3.Battlefront.Name, "market_to_battlefront_v01_01_c5r6.tgt");

        private static readonly TgtPosition DocksTgt
            = new TgtPosition(World.Act3.Docks.Name, "battlefield_arch_v0?_0?_c2r3.tgt");

        private static readonly TgtPosition Solaris1Tgt
            = new TgtPosition(World.Act3.SolarisTemple1.Name, "act3_temple_entrance_v01_01_c3r2.tgt");

        private static readonly TgtPosition Solaris2Tgt
            = new TgtPosition(World.Act3.SolarisTemple2.Name, "templeclean_exit_down_v01_01_c1r3.tgt");

        private static readonly TgtPosition EbonyBarracksTgt
            = new TgtPosition(World.Act3.EbonyBarracks.Name, "sewerexit_v01_01_c3r1.tgt");

        private static readonly TgtPosition Lunaris1Tgt
            = new TgtPosition(World.Act3.LunarisTemple1.Name, "act3_temple_entrance_v01_01_c3r2.tgt");

        private static readonly TgtPosition Lunaris2Tgt
            = new TgtPosition(World.Act3.LunarisTemple2.Name, "templeclean_exit_down_v01_01_c1r3.tgt");

        private static readonly TgtPosition ImperialGardensTgt
            = new TgtPosition(World.Act3.ImperialGardens.Name, "garden_arch_v01_01_c2r5.tgt");

        private static readonly TgtPosition LibraryTgt
            = new TgtPosition(World.Act3.Library.Name, "Library_LargeBuilding_entrance_v01_01_c2r2.tgt");

        private static readonly TgtPosition ArchivesTgt
            = new TgtPosition(World.Act3.Archives.Name, "library_entrance_v02_01_c2r3.tgt");

        private static readonly TgtPosition SceptreOfGodTgt
            = new TgtPosition(World.Act3.SceptreOfGod.Name, "Act3_EpicDoor_v0?_0?_c7r6.tgt");

        private static readonly TgtPosition UpperSceptreTgt
            = new TgtPosition("Next tower level", "tower_transition_up_01_01_c1r2.tgt", true);

        private static readonly TgtPosition AqueductTgt
            = new TgtPosition("Next tower level", "tower_transition_up_01_01_c1r2.tgt | tower_totowertop_v01_01_c2r2.tgt | Act3_tower_01_01_c13r9.tgt", true, 10, 40);

        private static readonly TgtPosition HighgateTgt
            = new TgtPosition(World.Act4.Highgate.Name, "mountiantown_connection_c7r12.tgt");

        private static readonly TgtPosition Mines2Tgt
            = new TgtPosition(World.Act4.Mines2.Name, "mine_areatransition_v0?_0?_c2r2.tgt");

        private static readonly TgtPosition CrystalVeinsTgt
            = new TgtPosition(World.Act4.CrystalVeins.Name, "mine_areatransition_v03_01_c1r1.tgt");

        private static readonly TgtPosition RaptureDeviceTgt
            = new TgtPosition("Rapture Device", "crystals_openAnimation_v01_01_c3r3.tgt");

        private static readonly TgtPosition KaomStrongholdTgt
            = new TgtPosition(World.Act4.KaomStronghold.Name, "lava_abyss_transition_entrance_v0?_0?_c3r1.tgt", false, 10, 50);

        private static readonly TgtPosition GrandArenaTgt
            = new TgtPosition(World.Act4.GrandArena.Name, "arena_areatransition_v01_01_c2r2.tgt");

        private static readonly TgtPosition Belly2Tgt
            = new TgtPosition(World.Act4.BellyOfBeast2.Name, "belly_tunnel_v01_01_c2r3.tgt");

        private static readonly TgtPosition HarvestTgt
            = new TgtPosition(World.Act4.Harvest.Name, "belly_tunnel_level2_v01_02_c2r3.tgt");

        private static readonly TgtPosition OverseerTowerTgt
            = new TgtPosition(World.Act5.OverseerTower.Name, "tower_v01_01_c9r4.tgt");

        private static readonly TgtPosition OriathSquareTgt
            = new TgtPosition(World.Act5.OriathSquare.Name, "security_exit_v01_01_c1r5.tgt");

        private static readonly TgtPosition TemplarCourtsTgt
            = new TgtPosition(World.Act5.TemplarCourts.Name, "Oriath_AreaTransition_v01_03_c2r2.tgt");

        private static readonly TgtPosition ChamberOfInnocenceTgt
            = new TgtPosition(World.Act5.TemplarCourts.Name, "templar_to_innocents_v01_01_c2r1.tgt");

        private static readonly TgtPosition TorchedCourtsTgt
            = new TgtPosition(World.Act5.TorchedCourts.Name, "transition_chamber_to_courts_v01_01_c3r4.tgt");

        private static readonly TgtPosition RuinedSquareTgt
            = new TgtPosition(World.Act5.RuinedSquare.Name, "templar_oriath_transition_v01_01_c2r2.tgt");

        private static readonly TgtPosition ReliquaryTgt
            = new TgtPosition(World.Act5.Reliquary.Name, "Oriath_AreaTransition_v01_02_c2r2.tgt");

        private static readonly TgtPosition OssuaryTgt
            = new TgtPosition(World.Act5.Ossuary.Name, "Oriath_AreaTransition_v01_04_c2r2.tgt");

        private static readonly TgtPosition CathedralRooftopTgt
            = new TgtPosition(World.Act5.CathedralRooftop.Name, "chitus_statuewall_transition_v01_01_c2r3.tgt");

        private static readonly TgtPosition TidalIslandTgt_A6
            = new TgtPosition(World.Act6.TidalIsland.Name, "karui_coast_to_island_transition_v01_01_c9r3.tgt");

        private static readonly TgtPosition MudFlatsTgt_A6
            = new TgtPosition(World.Act6.MudFlats.Name, "act6_area2_transition_v01_01_c4r2.tgt");

        private static readonly TgtPosition KaruiFortressTgt
            = new TgtPosition(World.Act6.KaruiFortress.Name, "beach_karuipools_v01_01_c6r4.tgt");

        private static readonly TgtPosition RidgeTgt
            = new TgtPosition(World.Act6.Ridge.Name, "swamp_to_ridge_v01_01_c5r3.tgt");

        private static readonly TgtPosition LowerPrisonTgt_A6
            = new TgtPosition(World.Act6.LowerPrison.Name, "ledge_prisonback_c5r3.tgt");

        private static readonly TgtPosition ShavronneTowerTgt
            = new TgtPosition(World.Act6.ShavronneTower.Name, "shavronne_prison_door_up_v01_01_c2r1.tgt");

        private static readonly TgtPosition PrisonerGateTgt_A6
            = new TgtPosition("Next tower level", "dungeon_prison_exit_up_v01_01_c1r1.tgt | prison_ladder_v01_01.tgt | tower_spiral_stair_v01_01_c2r1.tgt | dungeon_prison_door_up_v01_01_c1r1.tgt", true);

        private static readonly TgtPosition WesternForestTgt_A6
            = new TgtPosition(World.Act6.WesternForest.Name, "beach_passageblock_v01_01_c5r3.tgt");

        private static readonly TgtPosition RiverwaysTgt_A6
            = new TgtPosition(World.Act6.Riverways.Name, "roadtothickforest_entrance_v01_01_c5r2.tgt");

        private static readonly TgtPosition WetlandsTgt_A6
            = new TgtPosition(World.Act6.Wetlands.Name, "bridgeconnection_v01_01_c2r2.tgt");

        private static readonly TgtPosition SouthernForestTgt_A6
            = new TgtPosition(World.Act6.SouthernForest.Name, "forest_to_river_v01_01_c6r2.tgt");

        private static readonly TgtPosition CavernOfAngerTgt_A6
            = new TgtPosition(World.Act6.CavernOfAnger.Name, "forest_caveentrance_v01_01_c2r4.tgt");

        private static readonly TgtPosition BeaconTgt
            = new TgtPosition(World.Act6.Beacon.Name, "caveup_exit_v01_01_c2r2.tgt");

        private static readonly TgtPosition CrossroadsTgt_A7
            = new TgtPosition(World.Act7.Crossroads.Name, "bridgeconnection_v01_01_c2r2.tgt", false, 10, 50);

        private static readonly TgtPosition FellshrineTgt_A7
            = new TgtPosition(World.Act7.FellshrineRuins.Name, "wall_gate_v01_01_c2r3.tgt");

        private static readonly TgtPosition CryptTgt_A7
            = new TgtPosition(World.Act7.Crypt.Name, "church_dungeon_entrance_v01_01_c1r2.tgt");

        private static readonly TgtPosition ChamberOfSins1Tgt_A7
            = new TgtPosition(World.Act7.ChamberOfSins1.Name, "temple_entrance_v01_01_c2r5.tgt");

        private static readonly TgtPosition ChamberOfSins2Tgt_A7
            = new TgtPosition(World.Act7.ChamberOfSins2.Name, "templeruinforest_exit_down_v01_01_c1r4.tgt");

        private static readonly TgtPosition DenTgt_A7
            = new TgtPosition(World.Act7.Den.Name, "templeruinforest_maligaro_passage_c1r1.tgt");

        private static readonly TgtPosition AshenFieldsTgt
            = new TgtPosition(World.Act7.AshenFields.Name, "forestcaveup_exit_v01_01_c2r2.tgt");

        private static readonly TgtPosition NorthernForestTgt_A7
            = new TgtPosition(World.Act7.NorthernForest.Name, "oldfields_campboss_v01_01_c8r4.tgt | oldfields_campboss_v01_01_c4r10.tgt", true, 10, 20);

        private static readonly TgtPosition DreadThicketTgt_A7
            = new TgtPosition(World.Act7.DreadThicket.Name, "grovewall_entrance_v01_01_c2r1.tgt");

        private static readonly TgtPosition CausewayTgt
            = new TgtPosition(World.Act7.Causeway.Name, "forestriver_plinthtransition_v01_01_c6r2.tgt");

        private static readonly TgtPosition VaalCityTgt
            = new TgtPosition(World.Act7.VaalCity.Name, "vaal_stairs_bottom_v01_01_c4r7.tgt", false, 15);

        private static readonly TgtPosition TempleOfDecay1Tgt
            = new TgtPosition(World.Act7.TempleOfDecay1.Name, "BanteaySrei_Web_c3r4.tgt");

        private static readonly TgtPosition TempleOfDecay2Tgt
            = new TgtPosition("Next temple level", "dungeon_web_stairs_down_v01_01_c1r2.tgt", true);

        private static readonly TgtPosition SarnRampartsTgt
            = new TgtPosition("Next temple level", "dungeon_web_stairs_down_v01_01_c1r2.tgt | dungeon_web_inca_exit_v03_01_c1r1.tgt | dungeon_web_inca_exit_v01_01_c1r1.tgt", true);

        private static readonly TgtPosition SarnEncampmentTgt_A8
            = new TgtPosition("Next ramparts level", "ramparts_wall_accesss_v01_01_c5r2.tgt | act8_docks_v01_01_c1r2.tgt");

        private static readonly TgtPosition DoedreCesspoolTgt
            = new TgtPosition(World.Act8.DoedreCesspool.Name, "sewerwall_end_tunnel_v01_0?_c2r2.tgt");

        private static readonly TgtPosition GrandPromenadeTgt
            = new TgtPosition(World.Act8.GrandPromenade.Name, "slum_sewer_entrance_v03_01.tgt | doedre_sewer_grate_v01_01_c5r2.tgt | sewer_ladder_up_v01_01_c2r1.tgt", true);

        private static readonly TgtPosition QuayTgt
            = new TgtPosition(World.Act8.Quay.Name, "slum_sewer_entrance_v03_01.tgt | doedre_sewer_grate_v01_01_c5r2.tgt | sewerwall_exit_v01_01_c1r1.tgt", true);

        private static readonly TgtPosition GrainGateTgt
            = new TgtPosition(World.Act8.GrainGate.Name, "market_transition_warehouse_v01_01_c1r4.tgt");

        private static readonly TgtPosition ImperialFieldsTgt
            = new TgtPosition(World.Act8.ImperialFields.Name, "act8_grain_gate_transition_v01_01_c8r6.tgt");

        private static readonly TgtPosition Solaris1Tgt_A8
            = new TgtPosition(World.Act8.SolarisTemple1.Name, "act8_temple_entrance_v01_01_c3r2.tgt");

        private static readonly TgtPosition Solaris2Tgt_A8
            = new TgtPosition(World.Act8.SolarisTemple2.Name, "templeclean_exit_down_v01_01_c1r3.tgt");

        private static readonly TgtPosition SolarisConcourseTgt
            = new TgtPosition(World.Act8.SolarisConcourse.Name, "temple_to_battlefront_v01_01_c3r3.tgt");

        private static readonly TgtPosition BathHouseTgt
            = new TgtPosition(World.Act8.BathHouse.Name, "arch_promenade_to_arsenal_v01_01_c2r4.tgt");

        private static readonly TgtPosition HighGardensTgt
            = new TgtPosition(World.Act8.HighGardens.Name, "bathhouse_transition_v01_01_c1r1.tgt", true);

        private static readonly TgtPosition LunarisConcourseTgt
            = new TgtPosition(World.Act8.LunarisConcourse.Name, "bathhouse_transition_v01_01_c1r1.tgt");

        private static readonly TgtPosition Lunaris1Tgt_A8
            = new TgtPosition(World.Act8.LunarisTemple1.Name, "act3_temple_entrance_v01_01_c3r2.tgt");

        private static readonly TgtPosition Lunaris2Tgt_A8
            = new TgtPosition(World.Act8.LunarisTemple2.Name, "templeclean_exit_down_v01_01_c1r3.tgt");

        private static readonly TgtPosition HarbourBridgeTgt
            = new TgtPosition(World.Act8.HarbourBridge.Name, "act3_riverbridge_transition_v01_01_c8r7.tgt");

        private static readonly TgtPosition BloodAqueductTgt
            = new TgtPosition(World.Act9.BloodAqueduct.Name, "bridge_arena_v01_01_c11r7.tgt | bridge_arena_v01_01_c10r17.tgt", true);

        private static readonly TgtPosition HighgateTgt_A9
            = new TgtPosition(World.Act9.Highgate.Name, "mountiantown_connection_blood_c7r12.tgt");

        private static readonly TgtPosition VastiriDesertTgt
            = new TgtPosition("Next Descent level", "descent_top_winch_v01_01_c2r4.tgt | descent_ravine_convex_winch_v01_01_c1r2.tgt | decent_ravinestraight_tocliff_winch_v01_01_c1r2.tgt", true);

        private static readonly TgtPosition OasisTgt
            = new TgtPosition(World.Act9.Oasis.Name, "wagons_transition_v01_01_c4r3.tgt");

        private static readonly TgtPosition FoothillsTgt
            = new TgtPosition(World.Act9.Foothills.Name, "desert_to_foothills_v01_01_c4r2.tgt");

        private static readonly TgtPosition BoilingLakeTgt
            = new TgtPosition(World.Act9.BoilingLake.Name, "foothills_to_boilinglakev01_01_c4r4.tgt");

        private static readonly TgtPosition TunnelTgt
            = new TgtPosition(World.Act9.Tunnel.Name, "foothills_tunnel_exit_v01_01_c4r6.tgt");

        private static readonly TgtPosition QuarryTgt
            = new TgtPosition(World.Act9.Quarry.Name, "tunnels_to_quarry_transition_v01_01_c1r2.tgt");

        private static readonly TgtPosition RefineryTgt
            = new TgtPosition(World.Act9.Refinery.Name, "warehouse_entrance_v01_01_c6r3.tgt");

        private static readonly TgtPosition BellyTgt_A9
            = new TgtPosition(World.Act9.BellyOfBeast.Name, "BeastMembrane_c3r3.tgt");

        private static readonly TgtPosition RottingCoreTgt
            = new TgtPosition(World.Act9.RottingCore.Name, "belly_to_quarry_v01_01_c2r3.tgt");

        private static readonly TgtPosition RavagedSquareTgt
            = new TgtPosition(World.Act10.RavagedSquare.Name, "cathedral_roof_transition_v01_01_c8r18.tgt");

        private static readonly TgtPosition OssuaryTgt_A10
            = new TgtPosition(World.Act10.Ossuary.Name, "Oriath_AreaTransition_v01_04_c2r2.tgt");

        private static readonly TgtPosition TorchedCourtsTgt_A10
            = new TgtPosition(World.Act10.TorchedCourts.Name, "Oriath_AreaTransition_v01_03_c2r2.tgt");

        private static readonly TgtPosition ReliquaryTgt_A10
            = new TgtPosition(World.Act10.Reliquary.Name, "Oriath_AreaTransition_v01_02_c2r2.tgt");

        private static readonly TgtPosition ControlBlocksTgt_A10
            = new TgtPosition(World.Act10.ControlBlocks.Name, "slaveden_entrance_steps_v01_01_c1r1.tgt");

        private static readonly TgtPosition DesecratedChambersTgt
            = new TgtPosition(World.Act10.DesecratedChambers.Name, "templar_to_innocents_v01_01_c2r1.tgt");

        private static readonly TgtPosition CanalsTgt
            = new TgtPosition(World.Act10.Canals.Name, "OriathBlockage_v02_01_c4r2.tgt");

        private static readonly TgtPosition FeedingTroughTgt
            = new TgtPosition(World.Act10.FeedingTrough.Name, "CanalBridgeTransition_v01_01_c2r2.tgt");
        ...
        private static readonly WalkablePosition RiverwaysFromTown
            = new WalkablePosition(World.Act2.Riverways.Name, 81, 177);

        private static readonly WalkablePosition OldFieldsFromTown
            = new WalkablePosition(World.Act2.OldFields.Name, 303, 174);
        ...
        private static readonly WalkablePosition SlumsFromTown
            = new WalkablePosition(World.Act3.Slums.Name, 507, 410);
        ...
        private static readonly WalkablePosition BrokenBridgeFromTown
            = new WalkablePosition(World.Act7.BrokenBridge.Name, 324, 710);

        private static readonly WalkablePosition ToxicConduitsFromTown
            = new WalkablePosition(World.Act8.ToxicConduits.Name, 87, 545);
        ...
        private static readonly WalkablePosition LaboratoryFromTown
            = new WalkablePosition(World.Act11.TemplarLaboratory.Name, 1125, 1210);
